...
const SHRIMP_DATA = {
  params: {
    ...
    ph: {
      ...
      safe: [6.8, 7.2], warn: [6.5, 7.5], icon: '⚗️',
      advice: {
    ...
    kh: {
      label: 'KH (탄산경도)', unit: 'dKH',
      min: 0, max: 20, step: 0.5, default: 3,
      safe: [2, 5], warn: [1, 7], icon: '🪨',
      advice: {
    ...
    gh: {
      label: 'GH (총경도)', unit: 'dGH',
      min: 0, max: 20, step: 0.5, default: 6,
      safe: [4, 8], warn: [2, 10], icon: '💎',
      advice: {
    ...
    tds: {
      ...
      safe: [150, 250], warn: [100, 300], icon: '💧',
      advice: {
